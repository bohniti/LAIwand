...
def generate_gpt_reponse(gpt_input, max_tokens):
    ...
    openai.api_base = "https://eastus-asghackathon.openai.azure.com/"
...
if uploaded_file is None:
    ...
    if selected_mode == 'Ask your data':
        ...
        if st.button("Get Response"):
            ...
            try:
                # create gpt prompt
                gpt_input = "Write a sql lite query based on this question: {user_input}. The table name is {table_name} and the table has the following columns: {cols}.Return only a sql query and nothing else"
